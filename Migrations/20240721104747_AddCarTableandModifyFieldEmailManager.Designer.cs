...
namespace TE_trsprt_remake.Migrations
{
    ...
    [Migration("20240721104747_AddCarTableandModifyFieldEmailManager")]
    partial class AddCarTableandModifyFieldEmailManager
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TE_trsprt_remake.Models.Plant", b =>
                {
                    ...
                    b.HasOne("TE_trsprt_remake.Models.SAP", null)
                        .WithMany("Plants")
                        .HasForeignKey("SAPId1");
